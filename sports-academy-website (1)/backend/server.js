...
// Database setup
const db = new Database(path.join(__dirname, '../database/sports_academy.db'));
...
if (coachCount.count === 0) {
  ...
  [
    ...
    ['Simone Biles Coach', 'Gymnastics', 'USA', 18, 'World-renowned gymnastics performance specialist.'],
    ['Naomi Osaka Coach', 'Tennis', 'Japan', 15, 'Mental conditioning and technical precision expert.'],
  ...
  [
    ...
    ['Speed & Agility Boot Camp', 'Athletics', 1, '2025-06-18', '07:00', 'Track Oval', 25],
...
app.listen(PORT, () => console.log(`🏟️  Sports Academy server running on http://localhost:${PORT}`));
